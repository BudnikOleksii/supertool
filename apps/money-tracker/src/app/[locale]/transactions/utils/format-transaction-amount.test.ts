...
describe('formatTransactionAmount', () => {
  ...
  it('returns the raw amount when the value is not a finite number', () => {
    const actual = formatTransactionAmount('not-a-number', 'USD', 'en');
