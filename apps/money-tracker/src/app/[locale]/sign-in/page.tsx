...
const SignInPage: FC<Props> = async (props) => {
  ...
  const translate = await getTranslations(I18N_NAMESPACE.signInPage);
    ...
    <div className={styles.container}>
      <Card className={styles.card}>
        ...
        <CardContent className={styles.content}>
          <SignInFormSection submitLabel={translate('submit')} />
          <Typography>
            {translate('noAccount')}{' '}
            <UnderlineLink component={NavigationLink} href={ROUTES.signUp}>
