...
import type { SignInFormValues } from '../../constants/auth-form-schema';

import { authClient } from '../../auth/auth-client';
import { getAuthErrorMessageKey } from '../../auth/get-auth-error-message-key';
import { signInFormSchema } from '../../constants/auth-form-schema';
...
export const SignInForm: FC<SignInFormProps> = ({ onSuccess, submitLabel }) => {
